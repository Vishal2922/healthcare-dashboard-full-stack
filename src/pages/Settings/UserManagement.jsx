...
const SearchInput   = styled.input`width:100%;height:40px;border:1.5px solid #e2e8f0;border-radius:10px;padding:0 14px 0 36px;font-family:'DM Sans',sans-serif;font-size:14px;color:#0e1b2a;background:white;outline:none;box-sizing:border-box;transition:border-color 0.18s;&::placeholder{color:#b0bac4;}&:focus{border-color:#20b486;box-shadow:0 0 0 3px rgba(32,180,134,0.12);}`;
...
const FieldInput    = styled.input`width:100%;height:44px;border:1.5px solid #e2e8f0;border-radius:10px;padding:0 14px;font-family:'DM Sans',sans-serif;font-size:14px;color:#0e1b2a;outline:none;box-sizing:border-box;transition:border-color 0.18s;&:focus{border-color:#20b486;box-shadow:0 0 0 3px rgba(32,180,134,0.12);}`;
const FieldSelect   = styled.select`width:100%;height:44px;border:1.5px solid #e2e8f0;border-radius:10px;padding:0 14px;font-family:'DM Sans',sans-serif;font-size:14px;color:#0e1b2a;background:white;outline:none;cursor:pointer;box-sizing:border-box;&:focus{border-color:#20b486;}&:disabled{background:#f7f9fb;color:#a0aab4;cursor:not-allowed;}`;
