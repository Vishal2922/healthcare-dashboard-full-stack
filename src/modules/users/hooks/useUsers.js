...
import {
  fetchUsersRequest, fetchUserRequest,
...
import {
  selectUsers, selectUsersPagination, selectUsersFilters,
...
export default function useUsers() {
  ...
  return {
    ...
    loading, submitting, error, roles, departments,
    fetchUsers, fetchUserById, createUser, updateUser, deleteUser,
    toggleStatus, goToPage, fetchRoles, fetchDepartments,
